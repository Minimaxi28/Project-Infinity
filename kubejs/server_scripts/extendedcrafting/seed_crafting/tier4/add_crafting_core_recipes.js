ServerEvents.recipes((event) => {
  ...
  mobseedcraftingtier4(event, [
    'mysticalagriculture:blaze_seeds',
    'mysticalagriculture:soul_jar',
    '{Souls:10.0d,Type:"mysticalagriculture:blaze"}',
  ]);
  mobseedcraftingtier4(event, [
    'mysticalagriculture:ghast_seeds',
    'mysticalagriculture:soul_jar',
    '{Souls:4.0d,Type:"mysticalagriculture:ghast"}',
  ]);
  mobseedcraftingtier4(event, [
    'mysticalagriculture:enderman_seeds',
    'mysticalagriculture:soul_jar',
    '{Souls:8.0d,Type:"mysticalagriculture:enderman"}',
  ]);
  ...
  seedcraftingtier4_1(event, [
    ...
    'redstone_arsenal:flux_metal_block',
  ]);
  seedcraftingtier4_1(event, [
  ...
  seedcraftingtier4_1(event, [
    ...
    'common_ore_library:tungsten_block',
  ]);
  seedcraftingtier4_1(event, [
  ...
  event
    .custom({
      ...
      ingredients: [
        ...
        {
          item: 'ender_dragon_loot:dragon_shard',
        },
        {
          item: 'ender_dragon_loot:dragon_shard',
        },
